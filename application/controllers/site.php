...
class Site extends CI_Controller 
{
	...
	function createpropertysubmit()
	{
		...
		else
		{
			...
			if($this->property_model->createproperty($name,$area,$description,$lat,$long,$price,$builder,$propertytype,$status,$brochure)==0)
	...
	function editpropertysubmit()
	{
		...
		else
		{
            ...
            if($brochure=="")
            {
                $brochure=$this->property_model->getpropertybrochurebyid($id);
                $brochure=$brochure->brochure;
            }
            
            
            
			if($this->property_model->editproperty($id,$name,$area,$description,$lat,$long,$price,$builder,$propertytype,$status,$brochure)==0)
	...
	function editpropertyinfosubmit()
	{
		...
		else
		{
			...
			if($this->property_model->editpropertyinfo($id,$propertyarea,$propertyage,$nearby,$bedroom,$bathroom,$kitchen,$floor)==0)
	...
	function createbuildersubmit()
	{
		...
		else
		{
			$name=$this->input->post('name');
			$description=$this->input->post('description');
			if($this->builder_model->createbuilder($name,$description)==0)
	...
	function editbuildersubmit()
	{
		...
		else
		{
			...
			$name=$this->input->post('name');
			$description=$this->input->post('description');
			if($this->builder_model->editbuilder($id,$name,$description)==0)
